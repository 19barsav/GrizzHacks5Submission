...
from kivymd.uix.button import MDRectangleFlatButton, MDFloatingActionButton,\
    MDTextButton, MDFillRoundFlatButton
from kivy.lang import Builder
from kivymd.uix.dialog import MDDialog

ContentDepoBar = '''
MDTextField:
    hint_text: "Enter URL/Article Transcription"
...
class ContentWarning(MDApp):
    ...
    def display_cw(self, obj): #import elements from your code to be used in this display message
        ...
        cwMessage = MDDialog(text='This message indicates that Sav Hasn\'t yet customized the dialog!'\
                            , size_hint=(0.7,1))
        cwMessage.open()
